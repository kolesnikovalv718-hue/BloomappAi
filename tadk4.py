...
# -------------------------------------------------
# Task 4: Страница обучения модели, анализа и сохранения
# Здесь:
# - обучение модели на CSV
# - сохранение модели и векторизатора (joblib)
# - точность, отчет, матрица ошибок
# - графики метрик и анализ сильных/слабых классов
# -------------------------------------------------
def run():
    st.title("📊 Обучение и анализ модели")
    st.markdown("---")

    file_path = "blooms_dataset.csv"

    if st.button("Запустить анализ и обучить модель"):
